...
public class EmailController {
    ...
    public void sendBookingInfoForCustomer(String userName,String email, String checkin,String checkout,String apartmentName,String apartmentCity,String apartmentCountry,String street){
        ...
        message.setText("Welcome " + capitalizaedUserName + "\nYour reservation has been registered succesfully between "+checkin
                +" and "+checkout+".\nThe apartment name is "+apartmentName+" from "+apartmentCity +","+apartmentCountry+" situated on "+street+
                "\nwe wish your stay there will be exactly as you wish!\nHave a nice day!");
        javaMailSender.send(message);
    ...
    private void sendContactFormEmail(String name, String email, String subject, String message) {
        ...
        String sendTo = "smartrent@gmail.com";
